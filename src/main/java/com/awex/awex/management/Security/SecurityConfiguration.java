...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http)throws Exception {		
		...
		.antMatchers("/addUser").hasAnyAuthority("Admin","HR Manager")
		.antMatchers("/addUser/**").hasAnyAuthority("Admin","HR Manager")
		.antMatchers("/editUesr").hasAnyAuthority("Admin","HR Manager")
		.antMatchers("/editUesr/**").hasAnyAuthority("Admin","HR Manager")
		.antMatchers("/getUser").hasAnyAuthority("Admin","HR Manager")
		.antMatchers("/getUser/**").hasAnyAuthority("Admin","HR Manager")
		.antMatchers("/active/**").hasAnyAuthority("Admin","HR Manager")
		.antMatchers("/deactive/**").hasAnyAuthority("Admin","HR Manager")
		.antMatchers("/allUsers").hasAnyAuthority("Admin","HR Manager")
		.antMatchers("/allActive").hasAnyAuthority("Admin","HR Manager")
		.antMatchers("/allUsersNN").hasAnyAuthority("Admin","HR Manager")
		.antMatchers("/allNonActive").hasAnyAuthority("Admin","HR Manager")
