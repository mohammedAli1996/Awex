    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            for(var i = 0 ; i < data.length ; i ++){
                document.getElementById("resultBody").innerHTML += "<td>"+data[i].name+"</td><td>"+data[i].emails+"</td><td>"+data[i].nationality+"</td><td><a class='btn btn-inverse-danger btn-icon' href='/getIbForm/"+data[i].id+"'><i class='ti-slice'></i></a></td>"    ;
            } 
